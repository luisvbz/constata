                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <a class="dropdown-item" href="{{ route('dnis.editar', [$dni->id]) }}"><i class="fas fa-edit"></i> Editar registro</a>
    ...
    function dataItems() {
        return {
            ...
            showModalDelete(item)
            {
                ...
                $('#mensajeDelete').html(`Seguro(a) que desea eliminar <strong>${item.numero_documento}</strong> de la base de datos?`);
