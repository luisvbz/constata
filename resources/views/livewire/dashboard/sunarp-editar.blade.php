                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="form.anio_fabricacion" class="form-control @error('form.anio_fabricacion') is-invalid @enderror" placeholder="Año de fabricación" />
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="form.anio_modelo" class="form-control @error('form.anio_modelo') is-invalid @enderror" placeholder="Año del modelo" />
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="file" wire:model="form.firma" class="form-control @error('form.firma') is-invalid @enderror" accept=".png,.jpeg,.jpg,.bmp,.gif" />
                                @error('form.firma')
                                <p class="help-text text-danger">{{ $message }}</p>
                                @enderror
                        ...
                        @if($this->form['firma_source'])
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                <label><strong>Firma Actual:</strong></label>
                                <img src="{{ $form['firma_source'] }}" alt="Firma" width="150">
                                <button wire:click.prevent="delFirma" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></button>
                            </div>
                        </div>
                        @endif
                    </div>
