...
<body>
    ...
    <table class="table" cellpadding="0" cellspacing="0">
        <tr>
            <td width="23%">
                <img src="data:image/png;base64,{!! base64_encode(\SimpleSoftwareIO\QrCode\Facades\QrCode::format('png')->margin(3)->size(160)->generate(url('/Sunarp/verTarjetavirtual/'.$item['codigo_verificacion']))) !!}" width="135" alt="QrCode">
            </td>
