...
class SunarpEditar extends Component
{
    ...
    protected function rules()
    {
        return [
            ...
            'form.anio_fabricacion' => 'required|digits:4',
            'form.anio_modelo' => 'nullable|digits:4',
            'form.asientos' => 'required|numeric|digits:2',
            'form.pasajeros' => 'required|numeric|digits:2',
            'form.ruedas' => 'required|numeric|digits:2',
            'form.ejes' => 'required|numeric|digits:2',
            'form.cilindros' => 'required|numeric|digits:2',
